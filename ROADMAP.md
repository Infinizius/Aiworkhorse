...
Tests              ██████████████████████░   ~96%  (46 Backend-Tests ✅; inkl. Goal-API, interner Tool-Guards und File-Ownership)
...
- 45 Backend-Tests in `backend/tests/`: health, security, chat-routing, models, goals.
...
> **Ergebnis:** 46 Backend-Tests, alle grün (0 Fehler).

**Backend (pytest) – `backend/tests/` – 46/46 ✅:**
...
**Abnahmekriterium:** ✅ `python -m pytest tests/ -v` → `46 passed`
...
- [x] End-to-End-Verifikation: Alle 46 Backend-Tests grün, API-Endpunkte live und erreichbar
...
M8: Tests                               [✅ Fertig]  → 45 Backend-Tests, alle grün ✓
