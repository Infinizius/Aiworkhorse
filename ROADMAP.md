...
```
Infrastruktur      ███████████████████████  ~100%  (Caddy HTTPS, 6 Core-Services, arq Worker, Goal-Engine)
...
Tests              ██████████████████████░   ~96%  (45 Backend-Tests ✅; inkl. Goal-API und interner Tool-Guards)
...
> **Ergebnis:** 45 Backend-Tests, alle grün (0 Fehler).

**Backend (pytest) – `backend/tests/` – 45/45 ✅:**
...
**Abnahmekriterium:** ✅ `python -m pytest tests/ -v` → `45 passed`
