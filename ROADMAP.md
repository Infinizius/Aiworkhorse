...
| **Backend-Tests (pytest)** | ✅ Fertig | 39 Tests: health, security (auth + injection + rate-limit), chat-routing, alle 10 models |
...
**Abnahmekriterium:** ✅ `python -m pytest tests/ -v` → `39 passed in <1s`
